...
const album: TypeAlbum = {
  ...
  songs: [
    ...
    EnumSongs.khudozhnik,
    EnumSongs.plastikaSna,
    EnumSongs.ritualSozhzheniyaKukol,
    EnumSongs.glotok,
    EnumSongs.stonOlitsetvoreniya,
    EnumSongs.gdeYestTi,
    EnumSongs.zhenshchinaBabochka,
    EnumSongs.radugaNadBenzinovoiLuzhei,
  ],
  info: `
